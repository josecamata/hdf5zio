...
//     FILE.open(path, ios::out);
    ...
    generation(database, size);

    heapSort(database, size);
...
/**************************************************************/
    ...
    myFile0.write(database, size, "Compression Test");
...
/*************************************************************/
    ...
    myFile1.write(database, size, "Compression Test");
...
/**************************************************************/
    ...
    myFile2.write(database, size, "Compression Test");
